...
scaledhrdataoutlierrm <- scaledhrdata1 %>% select(`001`,`002`,`003`,`004`,`005`,`006`,`007`,`008`,`009`,`012`,`013`,`014`,`015`,`016`,`017`,`018`,`019`,`020`,`021`,`022`,`023`,`024`,`025`,`026`,`027`,`028`,`029`,`030`,`031`,`033`,`034`,`035`,`036`,`037`,`038`,`039`,`040`, "drift")

othervariables <- scaledhrdata1 %>% select("drift","con", "sentence_number", "sentence_sen_mean", "sentence_sen_total", "sen", "storynum")
...
scaledhrdata1 <- merge(scaledhrdataoutlierrm, othervariables, c("drift"))
...
factsubset <- scaledhrdata1 %>% 
  select(`001`,`003`, `005`, `007`, `009`, `013`, `015`, `017`, `019`,`021`,`023`,`025`,`027`,`029`,`031`, `034`, `036`, `038`,`040`, storynum)

fictsubset <- scaledhrdata1 %>% 
  select(`002`,`004`, `006`, `008`, `012`, `014`, `016`, `018`, `020`,`022`,`024`,`026`,`028`,`030`,`033`, `035`, `037`, `039`, storynum)

pivotdf <- scaledhrdata1 %>% pivot_longer(`001`:`002`:`003`:`004`:`005`:`006`:`007`:`008`:`009`:`012`:`013`:`014`:`015`:`016`:`017`:`018`:`019`:`020`:`021`:`022`:`023`:`024`:`025`:`026`:`027`:`028`:`029`:`030`:`031`:`033`:`034`:`035`:`036`:`037`:`038`:`039`:`040`, "Participant_number")

newmodel <- lmerTest::lmer(value ~ sentence_sen_mean + con + drift + (1|Participant_number), data = pivotdf)
summary(newmodel)
