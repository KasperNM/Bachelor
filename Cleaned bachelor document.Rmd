...
scaledhrdata1 <- merge(scaledhrdataoutlierrm, scaledothervariables, c("drift"))
...
factsubset <- scaledhrdata1 %>% 
  select(`001`,`003`, `005`, `007`, `009`, `013`, `015`, `017`, `019`,`021`,`023`,`025`,`027`,`029`,`031`, `034`, `036`, `038`, storynum, drift, sentence_sen_mean, sentence_sen_total, sen, con, sentence_number, storynum, time)

fictsubset <- scaledhrdata1 %>% 
  select(`002`,`004`, `006`, `008`, `014`, `016`, `018`, `020`,`022`,`024`,`026`,`028`,`030`,`033`, `035`, `037`, `039`, storynum, drift, sentence_sen_mean, sentence_sen_total, sen, con, sentence_number, storynum, time)
...
hrdf_spec<-spectrum(scaledhrdata1$`002`,plot=FALSE)
